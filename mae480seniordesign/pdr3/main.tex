...
\begin{center}
    \begin{tabular}{|c||c||c|}
        \hline
         ...
         \hline
         Sponsor & Course Instructor & Technical Advbisor \\
         \hline
...
Flight Dynamics Team  & Secondary GNC Lead & System Integration \\
 ...
 zkgarris@ncsu.edu   & ahschol@ncsu.edu & aselkods@ncsu.edu  \\
 336-430-2386  & 919-578-4933 & 919-675-5388 \\
 \hline % 3 per row
 ...
 rchen12@ncsu.edu   & anavrat@ncsu.edu & lecrick@ncsu.edu  \\
 828-398-8268  & 704-840-2443 & 980-275-9921 \\
\hline
\end{tabular}
\end{center}
...
The concept of operations (CONOPs) illustrates the steps in which the STARS CubeSat will undergo to complete its mission.  To better organize and detail the steps of each phase, the CONOPS was divided into 3 phases: pre-mission, mission, and post-mission displayed in Figures \ref{fig:conop1} through \ref{fig:conop3}, respectively. The pre-mission phase consists of reaching orbit and initializing the system.  The mission phase details the interactions of the subsystems that enable the scientific data collection to reach the objective of the STARS mission. Finally, the post-mission phase discusses the end-of-life plan for the CubeSat. The images used in each CONOPs phase are stock images and are used in a representative capacity only.  
...
After the initial attitude alignment, the CubeSat battery will be charged using the system's solar panels since the battery at launch is not fully charged. This requires the same systems as the detumble maneuver with the addition of the solar panels. Charging will continue until the battery is fully charged. 
...
The activity of each subsystem during the pre-mission phase of the CubeSat is shown in figure \ref{fig:on1}.  The subsystems are all off initially and are slowly turned on throughout the pre-mission phase. 
...
\begin{enumerate} % FR 1  (CPE 1)
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            ...
            \begin{enumerate}
                \item “3U or 3U+ CubeSats’ center of gravity shall be located within 7 cm from its geometric center in the Z direction.” [5] \cite{} 
                \begin{itemize}
                ...
                \end{itemize}
                \item “Rails shall have a minimum width of 8.5mm... Rails will have a surface roughness less than 1.6 µm...The edges of the rails will be rounded to a radius of at least 1 mm.” [5] \cite{}
                \begin{itemize}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            ...
            \begin{enumerate}
                \item The CubeSat structure shall survive the 8.5 - 13 G’s from launch \cite{}. 
                    \begin{itemize}
                    ...
                    \end{itemize}
                \item CubeSat shall utilize Aluminum 7075, 6061, 5005, and/or 5052 for both the main CubeSat structure and the rails.” [5] \cite{} 
                    \begin{itemize}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            \item  “Deployables shall be constrained by the CubeSat, not the P-POD." [5] \cite{}
                \begin{enumerate}
                    \item “All deployables such as booms, antennas, and solar panels shall wait to deploy a minimum of 30 minutes after the CubeSat's deployment switch(es) are activated from P-POD ejection.” [5] \cite{}
                        \begin{itemize}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            ...
            \item The CubeSat shall transmit data at least twice every 24 hours. 
                ...
                \end{itemize}
            \item CubeSat shall transmit orbital location information every 30 seconds
                \begin{itemize}
                    \item Motivation: Monitoring location and use as a ping to ensure CubeSat is operational 
                    \item Verification: Installation and setup of software decoding package, executing transmit from onboard CubeSat while on the ground, and ensuring the signal is received properly [5]  
                \end{itemize}
        \end{enumerate}
    ...
    \item The design shall utilize the Goddard Golden Rules (GSFC-STD-1000) for design margin guidance.
        \begin{enumerate}
            \item The design shall abide by pre-phase A margins for the PDR analysis.
                \begin{enumerate}
                    \item “Identify all requirements necessary for minimum Mission success... Determine if a breach of any of these requirements will cause the minimum mission to fail.” [GODDARD Table 1.05]
                        \begin{itemize}
            ...
            \item The design shall abide by phase A margins for the CDR analysis.
                \begin{enumerate}
                    \item “Identify failures that would cause the minimum mission to fail and develop a design strategy to avoid single point failures.” [GODDARD Table 1.05] 
                        \begin{itemize}
                            \item Motivation: Determining the design margin for different phases of the design cycle of a space vehicle design is key to ensure mission success and Goddard Golden Rules serve as a guide to how much margin to include in a specified subsystem for satellite or spacecraft. This margin will enable future revisions of the design to take advantage of the margin for additional capabilities and mission requirements. 
                            \item Verification: Validation will be conducted by observing the margin of each subsystem in following the standards set by Goddard Golden Rules.   \end{itemize}
                \end{enumerate}
...
While actuators control the orientation of the CubeSat, sensors approximate the orientation and location of the CubeSat. Sensor selection is based upon the pointing and position accuracy requirements from the other subsystems. Additionally, it will depend on mass and volume constraints of the CubeSat. Due to the nature of the mission, fine pointing control is not required. To meet this pointing knowledge requirement, NASC will utilizing a sun sensor, magnetometer, and an IMU for attitude and location determination. This combination of sensors will enable CubeSat pointing knowledge of approximately five degrees and location knowledge of approximately 20 meters until the location knowledge is degraded over time. \cite{GNC_Kiss} The IMU position information can be updated with information from the ground tracking station ensuring the CubeSat has accurate position data to update the IMU. 
...
VHF and UHF communication systems often act in tandemn 
...
again idk how to get if off this line
...
%Some day, there will be a materials property table here.
...
\begin{equation}
    Q = P * t
\end{equation}
where Q is the rate of power flow in kWh and t is the unit time in hours.
%----------------------------------------------------------------------------------------
%	Baseline Design
%----------------------------------------------------------------------------------------
