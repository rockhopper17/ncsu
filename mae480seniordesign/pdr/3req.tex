...
\begin{enumerate} % FR 1  (CPE 1)
        ...
        \begin{enumerate}
            ...
            \begin{enumerate}
                ...
                \begin{itemize}
                    ...
                    \item Verification: Design the CubeSat for this parameter, then test the structure to determine the center of gravity location. 
                \end{itemize}
                ...
                \begin{itemize}
                    ...
                    \item Verification: Design rails around these parameters and measure them using digital calipers or laser precision measuring machine.
                \end{itemize}
            \end{enumerate}
        \end{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            \item The CubeSat shall resist the launch static and dynamics loads. 
            \begin{enumerate}
                ...
                \item "CubeSat shall utilize Aluminum 7075, 6061, 5005, and/or 5052 for both the main CubeSat structure and the rails.” \cite{CSS}
                    ...
                    \end{itemize}
            \end{enumerate}
        \item The CubeSat’s components shall resist vibration loads and avoid resonance. 
        \begin{enumerate}
            \item The CubeSat shall withstand any vibration frequency between 20–2000 HZ\cite{FEA2, FEA3, FEA4}. 
                \begin{itemize}
                        ...
                        \item Verification: Use ANSYS model analysis features on specific parts and on the assembled CAD model.
                    \end{itemize}
        \end{enumerate}
        \end{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            ...
            \item  “The CubeSat rails, which contact the P-POD rails and adjacent CubeSat standoffs, shall be hard anodized aluminum to prevent any cold welding within the P-POD.” \cite{CSS} 
                \begin{enumerate}
                    \item CubeSat shall be able to withstand an exit velocity of 1.6 m/s\cite{10Launch}. 
                           \begin{itemize}
                                \item Motivation: Meeting the P-POD standard.
                                \item Verification: Test rig should be constructed to mimic the pusher plate and spring ejection system, with a full functional verification of the CubeSat performed afterwards along with a manual inspection to ensure all parts remain in place. 
                            \end{itemize}
                \end{enumerate}
        \end{enumerate}
    \end{enumerate} % FR 4 (CPE 2)
    \item The CubeSat shall maintain its attitude and meet pointing requirements to complete mission tasks.
    \begin{enumerate}
        ...
        \begin{enumerate}
            ...
            \begin{itemize}
                ...
                \item Verification: Installation and setup of software decoding package, executing transmit from CubeSat while on the ground, and ensuring the signal is received properly \cite{CSS}. 
            \end{itemize}
        \end{enumerate}
    ...
    \begin{enumerate}
        \item The solar panels shall collect energy from the sun to distribute throughout the CubeSat via the power management system.
        \begin{enumerate}
            \item The battery shall be charged by the solar panels and used only when the power management system cannot distribute enough power harnessed from the solar panels. 
                \begin{itemize}
                    \item Motivation: Maintaining the power required needs for all subsystems of the CubeSat.
                    \item Verification: Environmental test chamber facility focusing on power management.
                \end{itemize}
        \end{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            \item The CubeSat shall maintain a temperature between –5°C to 20°C for the entire CubeSat \cite{NICK HELP}.  
                \begin{itemize}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            \item The CubeSat shall not collect the scientific data while transmitting data.
                \begin{itemize}
                    \item Motivation: While power system analysis has yet to be performed, it is not reasonable to assume that the satellite will have a power budget capable of running the 1 Watt sensor (as described in the design requirements) and a 4-13 Watt\cite{shop} transmitter simultaneously. Therefore, the satellite should have times allocated for data collection, and times allocated for data transmission. 
            ...
            \item The CubeSat shall transmit data at least twice every 24 hours. 
                \begin{itemize}
                    ...
                    \item Verification: Simulation of the data size captured over 24 hours and test of the performance of communication to the ground station.
                \end{itemize}
        \end{enumerate}
    \item The CubeSat shall have the ability to receive data from the ground station. 
        \begin{enumerate}
            ...
            \item The CubeSat shall be able to receive information from the ground station at a minimum rate of 2 kb/s.
                \begin{itemize}
                    \item Motivation: Ability to send commands to the satellite allows for versatile passivation systems, and allows for corrections to be made to systems during mission phase. 
                    \item Verification: Communications system activated and data packet sent to the satellite, with pre-programmed response returned from the satellite upon completion.   
                \end{itemize}
        \end{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            \item The CubeSat shall re-enter the earth’s atmosphere within 25 years of the mission's end. 
               \begin{itemize}
        ...
        \begin{enumerate}
            \item The power system will exhaust any remaining power after deploying the EoL system. 
                ...
                \end{itemize}
            \item The power system shall be safed, or disconnected. (The means of production of energy on board shall be deactivated in a permanent way.) 
                \begin{itemize}
                    \item Motivation: Battery overpressure is a leading cause of satellite break-up upon re-entry. In order to avoid this, the power generation must be stopped during the end-of-life operations as the amount of power drawn from other core systems will be diminished.
    ...
    \begin{enumerate}
        \item Orbit shall be 500km Sun-Synchronous with an inclination angle of 97.4 \degree.
        \begin{enumerate}
    ...
    \item The CubeSat shall maintain a functional orbit for a minimum of 3 months.
        \begin{enumerate}
            \item The components of the CubeSat shall be tested to ensure they are functioning initially, functioning throughout a normal cycle, and functioning before launch. 
                \begin{enumerate}
                    \item The CubeSat shall rectify electronic problems caused by radiation or alert the team of known errors. 
                        \begin{itemize}
                            ...
                            \item Verification: If proton beam testing is available, then the system can be tested to show that solutions exist. If not, then systems for repair must be put in place and tested synthetically. 
                        \end{itemize}
                \end{enumerate}
        \end{enumerate} % FR 11
        \item The CubeSat shall detect the presence of High-Energy particles that traverse the Inner Van-Allen belt.
            \begin{enumerate}
                \item The sensor on the payload shall determine the direction of the detected high-energy particle measurement.
                    \begin{enumerate}
                        \item The sensor shall distinguish between high-energy protons and high-energy electrons of flux ranges 0.5-40 MeV through three levels of detection, shown in Table \ref{tab:mev}:
                        \begin{table}[H]
                        \centering
                        \begin{tabular}{|l|c|c|} 
                        \hline
                        ...
                        \end{table}
                            \begin{itemize}
                        \item Motivation: The University of Colorado Boulder helped develop the REPT (Relativistic Electron and Proton Telescope) sensors used on the NASA Van Allen Probes, which studied the outer Van Allen belt. Gathering data on the radiation of the inner belt will further the understanding of the Van Allen radiation belts. 
                    ...
                    \item  Basic sensor requirements shall follow as described in the Table \ref{tab:blackbox}.
                        \begin{itemize}
                            \item Motivation: In order meet other requirements, such as \textbf{DR.1.1}, the parameters of the payload and its encompassed sensor must fit in a 1U sized box to allow space for the other crucial components to make the CubeSat operational. 
                    ...
                    \end{enumerate}
            \end{enumerate}
    \item The design shall utilize the Goddard Golden Rules\cite{GSFC-STD-1000} for design margin guidance.
        \begin{enumerate}
            \item The design shall abide by pre-phase A margins for the PDR analysis.
                \begin{enumerate}
                \item "ACS actuators (including propulsion) shall be sized for the current best estimate of spacecraft mass properties with 100\% design margin"\cite{GSFC-STD-1000}. 
                        \begin{itemize}
                            \item Motivation: Determining the design margin for different phases of the design cycle of a space vehicle design is key to ensure mission success and that Goddard Golden Rules serve as a guide for how much margin a specified subsystem for satellite or spacecraft should include. This margin will enable future revisions of the design to take advantage of the margin for additional capabilities and mission requirements. 
            ...
            \item The design shall abide by phase A margins for the CDR analysis.
                \begin{enumerate}
                    \item The thermal design concept produced shall have "minimum 5C margins, except for heater controlled elements which have a maximum 70\% heater duty cycle and two-phase flow systems which have a minimum 30\% heat transport margin. For Phase A, larger margins are advisable"\cite{GSFC-STD-1000}. 
                        \begin{itemize}
                            \item Motivation: Determining the design margin for different phases of the design cycle of a space vehicle design is key to ensure mission success and that Goddard Golden Rules serve as a guide for how much margin a specified subsystem for satellite or spacecraft should include. This margin will enable future revisions of the design to take advantage of the margin for additional capabilities and mission requirements. 
                            \item Verification: Validation will be conducted by observing the margin of each subsystem in following the standards set by Goddard Golden Rules.   \end{itemize}
                \end{enumerate}
